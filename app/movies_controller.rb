...
def can_be_created_in_a_block(title: "Home Alone", realease_date: 1990)
...
def can_find_by_multiple_attributes
  ...
  # realease_date == 2000
  # director == "Me"
  Movie.find_by(title: 'Title', realease_date: 2000, director: 'Me')
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies realeased after 2002 and ordered by 
  # realease date descending
  Movie.where("realease_date > 2002").order(realease_date: :desc)
end
...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    Movie.create(title: "Movie_#{i}", realease_date: 2000+i)
  end
